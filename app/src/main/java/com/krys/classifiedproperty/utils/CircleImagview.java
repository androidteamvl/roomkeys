package com.krys.classifiedproperty.utils;
...
public class CircleImagview extends AppCompatImageView {
    ...
    public CircleImagview(@NonNull Context context) {
        super(context);

        init();
    }

    public CircleImagview(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleImagview(@NonNull Context context, AttributeSet attrs, int defStyle) {
