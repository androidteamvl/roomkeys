...
class HomeCatAdapter(var catarray: ArrayList<HomeCatModel>?=null) : RecyclerView.Adapter<HomeCatAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val catModel:HomeCatModel = catarray!![position]
