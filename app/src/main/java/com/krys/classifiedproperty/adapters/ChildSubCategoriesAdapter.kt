...
class ChildSubCategoriesAdapter(val childArray:ArrayList<ChildSubCatModel>?=null) : RecyclerView.Adapter<ChildSubCategoriesAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val childSubCatModel:ChildSubCatModel = childArray!![position]
        Glide.with(holder.imageView.context)
            .load(childSubCatModel.sub_subcategory_icon)
            .diskCacheStrategy(DiskCacheStrategy.ALL)
            .into(holder.imageView)
        holder.textView.text = childSubCatModel.sub_subcategory_name
        holder.maincontainer.setOnClickListener(View.OnClickListener {
            onItemClickListener?.onItemClick(holder.maincontainer, position,childSubCatModel.sub_subcategory_id)
            rowindex=position;
