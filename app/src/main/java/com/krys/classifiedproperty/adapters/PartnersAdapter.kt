...
class PartnersAdapter(var catarray: ArrayList<PartnersModel>? = null) : RecyclerView.Adapter<PartnersAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val catModel:PartnersModel = catarray!![position]
